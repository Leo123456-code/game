 ...
 */
public enum XinFuBankChargeEnum {
    ...
    public static XinFuBankChargeEnum getByNum(String num){
        return valueOf(num);
    }

    private XinFuBankChargeEnum(Integer code,Integer type,String num,Integer otherType,String otherNum,String bankName){
        this.code=code;
        this.type=type;
        this.num=num;
